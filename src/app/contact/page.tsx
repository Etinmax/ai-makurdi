...
function ContactForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setStatus("success");
      setForm({ firstName: "", lastName: "", email: "", phone: "", department: "", subject: "", message: "", subscribe: false });
    } catch (err: any) {
      setStatus("error");
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-[#eef0ff] rounded-xl shadow-sm p-8">
      <div className="grid md:grid-cols-2 gap-5 mb-5">
        <div>
          <label className="block text-[16px] font-normal text-gray-700 mb-1.5">
          ...
          <input
            ...
            className="w-full border text-gray-800 bg-white border-gray-300 rounded-md px-3 py-2.5 text-[13px] focus:outline-none focus:border-[#1e2a78] transition-colors"
          />
        </div>
        <div>
          <label className="block text-[16px] font-normal text-gray-700 mb-1.5">
          ...
          <input
            ...
            value={form.lastName}
            onChange={handleChange}
            className="w-full text-gray-800 bg-white border border-gray-300 rounded-md px-3 py-2.5 text-[13px] focus:outline-none focus:border-[#1e2a78] transition-colors"
          />
        </div>
        <div>
          <label className="block text-[16px] font-normal text-gray-700 mb-1.5">
      ...
      <div className="mb-5">
        ...
        <div className="relative">
          <select
            ...
            onChange={handleChange}
            className="w-full border border-gray-300 rounded-md px-3 py-2.5 text-[16px] text-gray-500 focus:outline-none focus:border-[#1e2a78] transition-colors appearance-none bg-white"
          >
      ...
      <div className="mb-5">
        ...
        <input
          ...
          value={form.subject}
          onChange={handleChange}
          className="w-full text-gray-700 bg-white border border-gray-300 rounded-md px-3 py-2.5 text-[13px] focus:outline-none focus:border-[#1e2a78] transition-colors"
        />
      </div>
      ...
      <div className="mb-5">
        ...
        <textarea
          ...
          value={form.message}
          onChange={handleChange}
          className="w-full text-gray-700 bg-white border border-gray-300 rounded-md px-3 py-2.5 text-[13px] focus:outline-none focus:border-[#1e2a78] transition-colors resize-none"
        />
      </div>
      ...
      <div className="flex items-center gap-2 mb-6">
        <input
          ...
          onChange={handleChange}
          className="w-4 h-4 accent-[#1e2a78]"
        />
        <label htmlFor="subscribe" className="text-[16px] text-gray-600">
      ...
      {/* Status messages */}
      {status === "success" && (
        <div className="mb-5 px-4 py-3 rounded-md bg-green-50 border border-green-200 text-green-700 text-[15px]">
          ✅ Your message has been sent successfully! We'll get back to you soon.
        </div>
      )}
      {status === "error" && (
        <div className="mb-5 px-4 py-3 rounded-md bg-red-50 border border-red-200 text-red-600 text-[15px]">
          ❌ {errorMsg}
        </div>
      )}
      ...
      <button
        ...
        className="w-full bg-[#1a56db] hover:bg-[#1648c0] disabled:opacity-60 disabled:cursor-not-allowed transition-colors text-white font-normal text-[18px] py-3 rounded-md flex items-center justify-center gap-2"
      >
        {status === "loading" ? (
          <>
  ...
  return (
    <div className="w-full font-sans">
      ...
      <section className="relative w-full h-[400px] flex items-center justify-center text-center text-white">
        <img src="/adblock.jpg" alt="hero" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="max-w-full mx-auto px-4 sm:px-8 md:px-[75px]">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-17">
            ...
            <div className="bg-white items-center justify-center rounded-sm transform transition hover:-translate-y-2 shadow-md p-8 flex flex-col">
              ...
              <div className="flex items-center justify-center flex-col text-[16px] font[400] text-[#333333] leading-6 flex-1">
                <p><span className="font-[600]">Main Line:</span> +234 902 480 8977</p>
                <p><span className="font-[600]">Admissions:</span> +234 916 161 3842</p>
                <p><span className="font-[600]">Library:</span> +234 902 480 8977</p>
                <p><span className="font-[600]">ICT Help Desk:</span> +234 916 161 3842</p>
              </div>
              <div className="mt-4 flex justify-center items-center">
                <BlueBtn href="tel:+2349024808977" label="Call Now" />
              </div>
            </div>
            ...
            <div className="bg-white flex items-center justify-center rounded-sm transform transition hover:-translate-y-2 shadow-md p-8  flex-col">
              ...
              <div className="flex items-center justify-center flex-col text-[16px] font[400] text-[#333333] leading-6 flex-1">
                <p><span className="font-[600]">Rector's Office:</span> rector@makurdiai.com.ng</p>
                <p><span className="font-[600]">Admissions:</span> admissions@makurdiai.com.ng</p>
                <p><span className="font-[600]">Library:</span> library@makurdiai.com.ng</p>
                <p><span className="font-[600]">General Inquiries:</span> info@makurdiai.com.ng</p>
              </div>
              <div className="mt-4 flex justify-center items-center">
                <BlueBtn href="mailto:info@makurdiai.com.ng" label="Send Email" />
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2  gap-6">
            ...
            <div className="bg-white py-10 flex flex-col justify-center place-items-center transform transition hover:-translate-y-2 shadow-md rounded-md p-7">
              ...
              <div className="text-[16px] text-gray-700 mb-5">
                <p><span className="font-[600]">Website:</span> www.makurdiai.com.ng</p>
              </div>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                email: "admissions@makurdiai.com.ng",
                phone: "+234 902 480 8977",
              ...
              },
              {
                ...
                email: "academic@makurdiai.com.ng",
                phone: "+234 916 161 3842",
              ...
              },
              {
                ...
                email: "library@makurdiai.com.ng",
                phone: "+234 916 161 3842",
              ...
              },
              {
                ...
                email: "bursary@makurdiai.com.ng",
                phone: "+234 916 161 3842",
        ...
        <div className="max-w-full mx-auto px-4 sm:px-8 md:px-[75px]">
          ...
          <div className="rounded-2xl overflow-hidden shadow-sm mb-8" style={{ height: 300 }}>
            <iframe
              ...
              referrerPolicy="no-referrer-when-downgrade" title="Augustinian Institute Location"
            />
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { title: "From Makurdi City Center", desc: "Take the Old GRA heading east. The Institute is located approximately 5km from the city center, on the right side of the road." },
              { title: "Public Transportation", desc: "Take a bus or taxi heading to Old GRA and ask to be dropped at Augustinian Institute. Most drivers are familiar with the location." },
              { title: "Parking Information", desc: "Visitor parking is available at the main entrance. Please check in at the security post for a visitor's pass." },
            ].map((info, i) => (
              <div key={i}>
